...
- (void)application:(UIApplication*)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData*)deviceToken {
    ...
    self.user.appID = tokenString;
    [[NSUserDefaults standardUserDefaults] setObject:tokenString forKey:@"appID"];
...
//                                    [[NSUserDefaults standardUserDefaults] objectForKey:@"appID"]);
...
//    NSString *username = [[[UIDevice currentDevice] name] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding ];
    ...
    NSLog(@" APP ID = %@", [[NSUserDefaults standardUserDefaults] objectForKey:@"appID"]);
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)info {
    ...
    if([UIApplication sharedApplication].applicationState == UIApplicationStateActive){
        ...
        //push types
        if([[info objectForKey:@"id"]  isEqualToString:@"RemovePair"]) {
        ...
        } else if([[info objectForKey:@"id"]  isEqualToString:@"AcceptPair"]) {
            [self.user receivedNotification:info withType:@"AcceptPair"];
        } else if([[info objectForKey:@"id"]  isEqualToString:@"RejectedPair"]) {
            [self.user receivedNotification:info withType:@"RejectedPair"];
        } else if([[info objectForKey:@"id"]  isEqualToString:@"Message"]) {
            [self.user receivedNotification:info withType:@"Message"];
            NSLog(@"Message");
        }
    }
