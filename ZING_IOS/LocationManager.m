...
- (void)startMonitoringLocation {
    ...
    _anotherLocationManager.desiredAccuracy = kCLLocationAccuracyNearestTenMeters ; //kCLLocationAccuracyBestForNavigation kCLLocationAccuracyNearestTenMeters;
    _anotherLocationManager.distanceFilter = 40.0f;
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations{
    ...
    for (int i = 0; i < locations.count; i++) {
        ...
        [[GlobalData shared] SetPastLocation:newLocation];
